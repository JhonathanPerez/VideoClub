...
class CrearCuentaUsuario(wx.Frame):
    ...
    def __init__(self, frame_father):
        super(CrearCuentaUsuario, self).__init__()
        self.xml = xrc.XmlResource('../View/crear_cuenta_usuario1.xml')
        self.frame = self.xml.LoadFrame(None, 'Frame_Crear_Cuenta_Usuario')
